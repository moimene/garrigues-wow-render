                  ...
                  return (
                    ...
                    >
                      ...
                      {isH && cell.obligaciones.length > 0 && (
                        <div className="absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 w-[220px] p-3 text-left" style={{ background: '#ffffff', borderRadius: 'var(--g-radius-md)', boxShadow: '0 8px 30px rgba(0,0,0,0.22)', border: '1px solid #d1d5db' }}>
